...
/* selectors */
export const getAll = ({kitchen}) => kitchen.data;
export const getLoadingState = ({kitchen}) => kitchen.loading;
...
export const fetchChangeStatusAPI = (row) => {
  return (dispatch) => {
    Axios
      .get(`${api.url}/api/${api.kitchen}${row.id}`, row)
      .then(res => {
